...
\begin{document}
	...
	\begin{figure}[htbp]
		...
		\begin{minipage}{0.45\textwidth} % Adjust the width as needed
			\centering
			\includegraphics[width=\linewidth]{constraints_ds.png} % Replace with your image file
		...
		\begin{minipage}{0.45\textwidth} % Adjust the width as needed
			\centering
			\includegraphics[width=\linewidth]{constraints_dp.png} % Replace with your image file
